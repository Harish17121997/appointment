        ...
        <div class="modal" role="dialog" aria-modal="true">
          ...
          <div v-if="mode === 'view'" class="modal__body">
            ...
            <div class="modal__actions">
              ...
              <button class="btn btn--billing" @click="goToBilling">
...
const emit = defineEmits(['close', 'submit', 'delete', 'go-to-billing'])
...
// ✅ NEW: Emit billing data to parent so it can redirect to Services > Billing tab
function goToBilling() {
  emit('go-to-billing', {
    name: props.booking?.name || '',
    phone: props.booking?.mobile || '',
...
.modal__actions { display: flex; gap: 10px; margin-top: 4px; justify-content: flex-end; flex-wrap: wrap; }
...
.btn--billing:hover { background: #dbeafe; }
